...
In order for this Integration to work with Github, you'll need a Github Personal Access Token. You can create your GitHub Personal Access token by following [the GitHub guide](https://docs.github.com/en/github/authenticating-to-github/creating-a-personal-access-token). Make a note of the Personal Access token, we'll need it later.

### 3. Setup Github Repository

If you don't have a Github Repository you may [create a new GitHub repository](https://github.com/new) to set one up.
...
In order to leverage the Notion API, we must first create an integration. To do that, [Notion My Integrations](https://www.notion.com/my-integrations), and click Create new integration.
